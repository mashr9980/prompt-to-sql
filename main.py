...
from app.routes import health, database, query
...
def create_app() -> FastAPI:
    app = FastAPI(
        ...
        ### Features
        - 🤖 AI-powered natural language to SQL conversion using LangChain
        ...
        ### Frontend
        Access the web interface at: `/app`

        ### API Endpoints
        - Check API health: `GET /api/health/quick`
        - View available tables: `GET /api/database/info`
        - Execute a query: `POST /api/query`
        - Execute SQL directly: `POST /api/sql`
